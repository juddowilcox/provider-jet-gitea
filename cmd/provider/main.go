...
func main() {
	var (
		app              = kingpin.New(filepath.Base(os.Args[0]), "Terraform based Crossplane provider for Gitea").DefaultEnvars()
	...
	log := logging.NewLogrLogger(zl.WithName("provider-jet-gitea"))
	if *debug {
	...
	mgr, err := ctrl.NewManager(cfg, ctrl.Options{
		...
		LeaderElectionID:           "crossplane-leader-election-provider-jet-gitea",
	...
	kingpin.FatalIfError(controller.Setup(mgr, o), "Cannot setup Gitea controllers")
