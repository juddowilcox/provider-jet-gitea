# Terrajet Gitea Provider

`provider-jet-gitea` is a [Crossplane](https://crossplane.io/) provider that
...
provider-jet-gitea is run according to the same
...
provider-jet-gitea adheres to the same [Code of
Conduct](https://github.com/crossplane/crossplane/blob/master/CODE_OF_CONDUCT.md)
as the core Crossplane project.

## Licensing

provider-jet-gitea is under the Apache 2.0 license.
